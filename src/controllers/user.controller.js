...
const loginUser = asyncHandler(async (req, res) => {
        //Get User Details such as - email or username and password
        //Check for user in th db
        //Get the password and match it
 ...
 // console.log(isPasswordValid)  -----> yeilds boolean value
   if(!isPasswordValid){
  ...
  const changeCurrentPassword = asyncHandler(async(req, res)=>{
    //Taking any field from user and then searching that into database
    //And then updating the password with mongodb
...
const getUserChannelProfile = asyncHandler(async (req, res)=>{    // This function includes everything that we can get from user profile of youtube
